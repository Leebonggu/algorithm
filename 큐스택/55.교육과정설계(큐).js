...
모든 과목은 영문 대문자입니다. 두 번 째 줄부터 현수가 짠 수업설계가 주어집니다.(수업설계의 길이는 30이하이다)
...
// const solution = function(ness, all) {
//   const r = ness.split('').map(n => all.split('').indexOf(n));
//   return r === r.sort((a, b) => a - b);
// };
